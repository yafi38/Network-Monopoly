...
public class Property {
    ...
    public Property[] createProperty() {
        ...
        properties[2]=new Property("Community Chest",0,0);//pick up community chest card
        properties[3]=new Property("Baltic Avenue",0,60);
        properties[4]=new Property("Income Tax",0,-200);//pay 200
        properties[5]=new Property("Reading Railroad",0,200);
        properties[6]=new Property("Oriental Avenue",0,100);
        properties[7]=new Property("Chance",0,0);//chance,pick up chance cards
        properties[8]=new Property("Vermont Avenue",0,100);
        properties[9]=new Property("Connecticut Avenue",0,120);
        properties[10]=new Property("In Jail(just visiting)",0,0);//in jail
        ...
        properties[17]=new Property("Community Chest",0,0);//pick up community chest card
        properties[18]=new Property("Tennessee Avenue",0,180);
        properties[19]=new Property("New York Avenue",0,200);
        properties[20]=new Property("Free Parking",0,0);//parking available
        properties[21]=new Property("Kentucky Avenue",0,220);
        properties[22]=new Property("Chance",0,0);//chance,pick up chance cards
        ...
        properties[30]=new Property("Go to Jail",0,0);//going to jail
        properties[31]=new Property("Pacific Avenue",0,300);
        properties[32]=new Property("North Carolina Avenue",0,300);
        properties[33]=new Property("Community Chest",0,0);//pick up community chest card
        properties[34]=new Property("Pennsylvania Avenue",0,320);
        properties[35]=new Property("Short Line",0,200);
        properties[36]=new Property("Chance",0,0);//chance,pick up chance cards
        properties[37]=new Property("Park place",0,350);
        properties[38]=new Property("Luxury Tax",0,-100);//pay 100
